...
class LowState(genpy.Message):
  _md5sum = "c6391a31b49613df585845d196052b97"
...
uint16[10] cell_vol        # cell voltage mV"""
  __slots__ = ['head','levelFlag','frameReserve','SN','version','bandWidth','imu','motorState','bms','footForce','footForceEst','tick','wirelessRemote','reserve','crc']
  _slot_types = ['uint8[2]','uint8','uint8','uint32[2]','uint32[2]','uint16','unitree_legged_msgs/IMU','unitree_legged_msgs/MotorState[20]','unitree_legged_msgs/BmsState','int16[4]','int16[4]','uint32','uint8[40]','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       head,levelFlag,frameReserve,SN,version,bandWidth,imu,motorState,bms,footForce,footForceEst,tick,wirelessRemote,reserve,crc
